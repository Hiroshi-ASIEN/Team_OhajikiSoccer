...
public class EnemyAI_Item : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_OwnGoal = GameObject.Find("EnemyGoal").GetComponent<Transform>();
        m_OpponentGoal = GameObject.Find("PlayerGoal").GetComponent<Transform>();
    ...
    public void Move()
    {
        ...
        m_Rb.velocity = m_NextDirection * m_NextSpeed;
    }
    ...
    {
        return Vector3.Distance(transform.position, m_Ball.position) < 2.0f;
    }
