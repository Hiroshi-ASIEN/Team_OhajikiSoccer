...
public class RoomListViewElement : MonoBehaviour
{
    ...
    private CustomRoomMatchmakingView matchmakingView;
    private Button button;

    public void Init(CustomRoomMatchmakingView parentView)
    {
        ...
        if (button == null)
        {
            Debug.LogError($"{gameObject.name} に Button コンポーネントが存在しません。");
            return;
        }
